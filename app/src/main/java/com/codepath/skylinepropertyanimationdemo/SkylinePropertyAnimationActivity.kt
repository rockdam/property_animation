...
class SkylinePropertyAnimationActivity : AppCompatActivity() {
    ...
    private fun animateBird() {
        ...
        ivBird!!.animate().x(metrics.widthPixels + 50.toFloat()).setStartDelay(1000).setDuration(ANIMATION_DURATION.toLong()).setInterpolator(AccelerateInterpolator()).setListener(object : AnimatorListenerAdapter() {
    ...
    private fun animateActionBar() {
        ...
        val actionBarColorAnim = ValueAnimator.ofObject(ArgbEvaluator(),
                colorFrom, colorTo)
